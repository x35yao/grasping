...
# Coordinates of the base of object in marker frame
...
# Translation
x1 = base_to_marker[object][0]
y1 = base_to_marker[object][1]
z1 = base_to_marker[object][2]
vect1 = [x1,y1,z1]
# Rotation
r1a_1 = [1,0,0]
r1a_2 = [0,1,0]
...
H1_a = homogenous_transform(R1_a,vect1) # without flip

r1b_1 = [-1,0,0]
r1b_2 = [0,-1,0]
r1b_3 = [0,0,1]
R1_b = [r1b_1,r1b_2,r1b_3]
H1_b = homogenous_transform(R1_b,vect1)
